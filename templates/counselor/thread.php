...
<div class="chat-page">
    <a href="/consultations" class="chat-back">&larr; Kembali ke Konsultasi Masuk</a>
    ...
    <div class="chat-box" id="chatBox" data-student-id="<?= (int) $student['id'] ?>">
        <?php if (empty($messages)): ?>
            <p class="chat-empty">Belum ada percakapan.</p>
        <?php endif; ?>
    ...
    <form method="post" action="/consultations/<?= (int) $student['id'] ?>" class="chat-form" id="chatForm">
        <input type="text" name="message" class="chat-input" placeholder="Ketik balasan..." autocomplete="off" required>
...
(function () {
    ...
    var studentId = box.dataset.studentId;
    ...
    setInterval(function () {
        fetch('/consultations/' + studentId + '/messages?after=' + lastMessageId())
...
$pageTitle = $title ?? 'Konsultasi';
$extraStyles = require __DIR__ . '/../chat/_styles.php';
